...
import { ChevronRight, Github, ImageUp, RotateCcw, Upload } from 'lucide-react'
...
const Scan: React.FC<ImageDropzoneProps> = ({ onFileAccepted }) => {
  ...
  return (
    <main className="flex justify-center pb-16 bg-gradient-dark flex-1">
            <div className="w-2/3 flex gap-12 p-24 border-l-2 border-b-2 text-white items-center max-lg:w-auto flex-col max-lg:p-8"></div>
